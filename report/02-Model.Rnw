...
MSE <- c(ols\_mse, ridge\_MSE, test\_mse, pcr\_MSE, mse)
mse\_chart <- data.frame(Regression, MSE)
mse\_tbl <- xtable(mse\_chart,
               caption = 'Test MSE Values for the Regression Techniques',
               digits = 7)

print(mse\_tbl, caption.placement = 'top',
...
line 160: \begin{figure}
\centering
\graphicspath{../images/Ridge_plot.png}
\includegraphics{Ridge_plot.png}
